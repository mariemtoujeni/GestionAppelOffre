...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/offres', title: 'Liste Offres',  icon:'ni-circle-08 text-pink', class: '' },
    ...
    { path: '/candidatByRecycleur/:idUser', title: 'candidat By recycleur',  icon:'ni-circle-08 text-pink', class: ''},
